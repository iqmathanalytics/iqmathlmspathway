...
const TOPICS: Record<string, TopicInfo> = {
  ...
  "ai-m1-t3": {
    ...
    hook: "LLM orchestration coordinates models, prompts, tools, retrieval, memory, and monitoring inside AI apps.",
    outcome: "You will understand how orchestration makes LLM applications scalable, reliable, and easier to maintain.",
    steps: ["Manage prompts", "Coordinate tools", "Monitor workflows"],
    example: "A support bot can retrieve context, call tools, preserve memory, and route work through an orchestration layer.",
    caution: "Without orchestration, multi-step LLM apps can become fragile, costly, and hard to debug.",
    icon: "brain",
  },
  "ai-m1-t4": {
    moduleLabel: "AI Foundations",
  ...
  "ai-m3-t1": {
    ...
    hook: "A Groq API key identifies your app when it calls Groq's fast LLM inference service.",
    outcome: "You will know how to create, copy, store, and protect a Groq API key.",
    steps: ["Open Groq Cloud", "Create API key", "Store securely"],
