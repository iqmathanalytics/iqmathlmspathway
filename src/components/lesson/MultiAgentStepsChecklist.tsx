...
const STEPS = [
  { id: 1, title: "Install Dependencies", snippet: "!pip install groq ...", color: "emerald" },
  { id: 2, title: "Define Agent Roles", snippet: "def run_agent(role, task): ...", color: "teal" },
  { id: 3, title: "Orchestrate the Agents", snippet: "facts = run_agent('researcher', ...)", color: "blue" },
] as const;
...
export function MultiAgentStepsChecklist() {
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
      {/* ── Header ── */}
      <div className="border-b border-slate-200 bg-gradient-to-r from-violet-50 to-purple-50 px-4 py-4">
        ...
        <div className="mt-3 space-y-1.5">
          <div className="flex items-center justify-between">
            ...
            <span className={`text-[11px] font-bold ${allDone ? "text-violet-700" : "text-slate-500"}`}>
              {pct}%
            </span>
          </div>
