...
`,
    tests: [
      { label: "Odd total", call: "findMedianSortedArrays([0, 2], [1])", expected: "1.0" },
      { label: "Even total", call: "findMedianSortedArrays([0, 0], [0, 0])", expected: "0.0" },
      { label: "One empty", call: "findMedianSortedArrays([], [5, 7])", expected: "6.0" },
    ],
  }),
...
`,
    tests: [
      {
        label: "Valley",
        call: "trap([5, 2, 1, 2, 1, 5])",
        expected: "14",
      },
      { label: "Two walls", call: "trap([2, 0, 2])", expected: "2" },
...
`,
    tests: [
      { label: "No star fail", call: 'isMatch("abc", "a")', expected: "False" },
      { label: "Star", call: 'isMatch("aaa", "a*")', expected: "True" },
      { label: "Dot star", call: 'isMatch("xyz", ".*")', expected: "True" },
