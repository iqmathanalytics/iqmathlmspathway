/** Intermediate (medium) Python Basics problem specs — 39 originals. */

export const mediumSpecs = [
  // ── SCRIPT (15) ──────────────────────────────────────────────────────────
...
Last line: 3 x 3 = 9`,
    ...
    starter: `# TODO: print 3x3 multiplication grid
`,
...
`,
    solution: `names = ["Alice", "Bob", "Charlie", "Diana"]
for rank, name in enumerate(names, start=1):
    print(f"{rank}. {name}")`,
    tests: [
      {
        label: "Four ranks",
        expectedStdout: "1. Alice\n2. Bob\n3. Charlie\n4. Diana",
      },
    ],
    examples: [{ output: "1. Alice\n2. Bob\n3. Charlie\n4. Diana" }],
  },
...
while n != 1:
    ...
    if n % 2 == 0:
        ...
        n = 3 * n + 1
print(1)`,
    tests: [{ label: "n=6 sequence", expectedStdout: "6\n3\n10\n5\n16\n8\n4\n2\n1" }],
    examples: [{ output: "6\n3\n10\n5\n16\n8\n4\n2\n1" }],
  },
...
4. 2 ** 3 ** 2  (right-associative)`,
    ...
    starter: `# TODO: print four expression results
`,
    solution: `print(2 + 3 * 4)
print((2 + 3) * 4)
print(10 // 3)
print(2 ** 3 ** 2)`,
    tests: [{ label: "Four results", expectedStdout: "14\n20\n3\n512" }],
    examples: [{ output: "14\n20\n3\n512" }],
  },
...
- otherwise the number itself`,
    ...
    starter: `# TODO: FizzBuzz for 1..15
`,
...
Use any correct approach (trial division is fine).`,
    ...
    starter: `# TODO: print primes 2..30
`,
...
for v in values:
    ...
    tests: [{ label: "Four averages", expectedStdout: "10.0\n15.0\n20.0\n25.0" }],
    examples: [{ output: "10.0\n15.0\n20.0\n25.0" }],
  },
...
Use f-strings with fixed widths: item left-aligned in 6 chars, qty right-aligned in 3 chars.`,
    ...
    starter: `# TODO: print formatted table
`,
    solution: `print(f"{'Item':<6}{'Qty':>3}")
print(f"{'Pen':<6}{12:>3}")
print(f"{'Note':<6}{8:>3}")`,
    tests: [{ label: "Three lines", expectedStdout: "Item  Qty\nPen    12\nNote    8" }],
    examples: [{ output: "Item  Qty\nPen    12\nNote    8" }],
  },
...
print(",".join(str(x) for x in sorted(a ^ b)))`,
    tests: [
      {
        label: "Four set lines",
        expectedStdout: "1,2,3,4,5,6\n3,4\n1,2\n1,2,5,6",
      },
    ],
    examples: [{ output: "1,2,3,4,5,6\n3,4\n1,2\n1,2,5,6" }],
  },
...
Round dist to 2 decimal places.`,
    ...
    starter: `points = [(0, 0), (3, 4), (-2, 5)]
# TODO: print coordinates and distances
`,
    solution: `points = [(0, 0), (3, 4), (-2, 5)]
for x, y in points:
    ...
    tests: [
      {
        label: "Three points",
        expectedStdout: "x=0, y=0, dist=0.0\nx=3, y=4, dist=5.0\nx=-2, y=5, dist=5.39",
      },
    ],
    examples: [{ output: "x=0, y=0, dist=0.0\nx=3, y=4, dist=5.0\nx=-2, y=5, dist=5.39" }],
  },
...
`,
    solution: `text = "to be or not to be"
counts = {}
for word in text.split():
    counts[word] = counts.get(word, 0) + 1
for word in sorted(counts):
    print(f"{word}: {counts[word]}")`,
    tests: [{ label: "Sorted counts", expectedStdout: "be: 2\nnot: 1\nor: 1\nto: 2" }],
    examples: [{ output: "be: 2\nnot: 1\nor: 1\nto: 2" }],
  },
...
Import json and print json.dumps(payload) on one line.`,
    ...
    starter: `# TODO: build dict and print JSON
`,
...
print(json.dumps(payload))`,
    tests: [
      {
        label: "One JSON line",
        expectedStdout: '{"course": "Python Basics", "week": 4, "topics": ["loops", "dicts"]}',
      },
    ],
    examples: [
      {
...
print(result)`,
    tests: [{ label: "Doubled evens", expectedStdout: "[4, 8, 12, 16]" }],
    examples: [{ output: "[4, 8, 12, 16]" }],
  },
...
- "retake" otherwise`,
    ...
    starter: `scores = [92, 74, 88, 59, 100]
# TODO: print band for each score
`,
    solution: `scores = [92, 74, 88, 59, 100]
for score in scores:
    if score >= 90:
        print("honors")
    elif score >= 70:
        ...
        print("retake")`,
    tests: [{ label: "Five bands", expectedStdout: "honors\npass\npass\nretake\nhonors" }],
    examples: [{ output: "honors\npass\npass\nretake\nhonors" }],
  },
...
Print the weekday index (0=Mon .. 6=Sun) after each offset using modulo:
  ...
  ...`,
    ...
    starter: `offsets = [0, 1, 6, 7, 13, 20]
# TODO: print weekday index for each offset
`,
    solution: `offsets = [0, 1, 6, 7, 13, 20]
for offset in offsets:
    print(offset % 7)`,
    tests: [{ label: "Six indices", expectedStdout: "0\n1\n6\n0\n6\n6" }],
    examples: [{ output: "0\n1\n6\n0\n6\n6" }],
  },
...
Example: build_profile("Sam", city="Boston", role="TA") -> {"name": "Sam", "city": "Boston", "role": "TA"}`,
    ...
    starter: `def build_profile(name, **info):
...
`,
    tests: [
      {
        label: "With extras",
        call: 'build_profile("Sam", city="Boston", role="TA")',
        expected: '{"name": "Sam", "city": "Boston", "role": "TA"}',
      },
      { label: "Name only", call: 'build_profile("Alex")', expected: '{"name": "Alex"}' },
    ],
    examples: [
      {
        input: 'build_profile("Sam", city="Boston", role="TA")',
        output: '{"name": "Sam", "city": "Boston", "role": "TA"}',
      },
    ],
  },
...
If title is omitted, use "Student".`,
    ...
    starter: `def greet(name, title="Student"):
    # Write your code here
    pass
`,
    solution: `def greet(name, title="Student"):
...
`,
    tests: [
      {
        label: "Overlap",
        call: 'merge_counts({"a": 2, "b": 1}, {"b": 3, "c": 1})',
        expected: '{"a": 2, "b": 4, "c": 1}',
      },
      { label: "Empty second", call: 'merge_counts({"x": 1}, {})', expected: '{"x": 1}' },
    ],
    examples: [
      {
        input: 'merge_counts({"a": 2, "b": 1}, {"b": 3, "c": 1})',
        output: '{"a": 2, "b": 4, "c": 1}',
      },
    ],
  },
...
Example: '  apple, banana ,cherry  ' -> ['apple', 'banana', 'cherry']`,
    ...
    starter: `def parse_csv_line(line):
    # Write your code here
    pass
`,
...
`,
    tests: [
      {
        label: "Spaced fields",
        call: 'parse_csv_line("  apple, banana ,cherry  ")',
    ...
    examples: [
      {
        input: 'parse_csv_line("  apple, banana ,cherry  ")',
...
- contains at least one lowercase letter`,
    ...
    starter: `def is_strong_password(text):
    # Write your code here
    pass
`,
    solution: `def is_strong_password(text):
    if len(text) < 8:
        return False
...
`,
...

  {
    ...
    starter: `def sym_diff_sorted(a, b):
    # Write your code here
    pass
`,
    solution: `def sym_diff_sorted(a, b):
...
If scores tie, sort names alphabetically ascending among ties.`,
    ...
    starter: `def top_scores(records, n):
    # Write your code here
    pass
`,
    solution: `def top_scores(records, n):
...
`,
    tests: [
      {
        label: "Top 2",
        call: 'top_scores([("Ann", 88), ("Bob", 92), ("Cal", 92), ("Di", 70)], 2)',
        expected: '["Bob", "Cal"]',
      },
      {
        label: "Tie break",
        call: 'top_scores([("Zed", 50), ("Amy", 50)], 2)',
        expected: '["Amy", "Zed"]',
      },
    ],
    examples: [
      {
        input: 'top_scores([("Ann", 88), ("Bob", 92), ("Cal", 92)], 2)',
        output: '["Bob", "Cal"]',
      },
    ],
  },
...
Treat blank or whitespace-only lines as empty.`,
    ...
    starter: `def non_empty_lines(text):
    # Write your code here
    pass
`,
    solution: `def non_empty_lines(text):
    result = []
...
`,
    tests: [
      {
        label: "Mixed blank lines",
        call: 'non_empty_lines("alpha\\n\\n beta \\n\\ngamma")',
    ...
    tests: [
      {
        ...
        call: 'merge_configs(\'{"theme": "light", "lang": "en"}\', \'{"theme": "dark"}\')',
        expected: '{"theme": "dark", "lang": "en"}',
      },
      {
        label: "Disjoint keys",
        call: 'merge_configs(\'{"a": 1}\', \'{"b": 2}\')',
        expected: '{"a": 1, "b": 2}',
      },
    ],
    examples: [
      {
        input: 'merge_configs(\'{"theme": "light"}\', \'{"theme": "dark"}\')',
        output: '{"theme": "dark"}',
      },
    ],
  },
...
Return matches in order of appearance.`,
    ...
    hints: [String.raw`r"\d{3}-\d{3}-\d{4}"`],
...
`,
    tests: [
      {
        label: "Two numbers",
        call: 'find_phones("Call 555-123-4567 or 800-999-0000 today")',
        expected: '["555-123-4567", "800-999-0000"]',
      },
      { label: "None", call: 'find_phones("no phones")', expected: "[]" },
    ],
    examples: [
      {
        input: 'find_phones("555-123-4567")',
        output: '["555-123-4567"]',
      },
    ],
  },
...
If any value would collide (duplicate values), return None instead.`,
    ...
    starter: `def invert_unique(mapping):
    # Write your code here
    pass
`,
    solution: `def invert_unique(mapping):
    seen = set()
    result = {}
...
Example: "A man, a plan, a canal: Panama" -> True`,
    ...
    starter: `def is_phrase_palindrome(text):
    # Write your code here
    pass
`,
    solution: `def is_phrase_palindrome(text):
...
Return the value at the path, or None if any key is missing.`,
    ...
    starter: `def get_path(data, keys):
    # Write your code here
    pass
`,
    solution: `def get_path(data, keys):
    current = data
    for key in keys:
...
`,
    tests: [
      {
        label: "Deep path",
        call: 'get_path({"a": {"b": {"c": 42}}}, ["a", "b", "c"])',
        expected: "42",
      },
      {
        label: "Missing",
        call: 'get_path({"a": 1}, ["a", "b"])',
        expected: "None",
      },
...
Skip any item that raises ValueError; return a list of successful conversions in order.`,
    ...
    starter: `def parse_int_list(strings):
    # Write your code here
    pass
`,
    solution: `def parse_int_list(strings):
    result = []
    for s in strings:
        try:
            result.append(int(s))
...
`,
    tests: [
      {
        ...
        call: 'parse_int_list(["1", "x", "3", "4.5", "5"])',
        expected: "[1, 3, 5]",
      },
    ...
    examples: [
      {
        input: 'parse_int_list(["10", "bad", "20"])',
        output: "[10, 20]",
      },
    ],
  },
...
Write group_names(records) returning a dict mapping each category to a list of names (insertion order within each list).`,
    ...
    pass
`,
    solution: `def group_names(records):
    groups = {}
    ...
    tests: [
      {
        ...
        call: 'group_names([{"category": "fruit", "name": "apple"}, {"category": "veg", "name": "carrot"}, {"category": "fruit", "name": "banana"}])',
        expected: '{"fruit": ["apple", "banana"], "veg": ["carrot"]}',
      },
    ],
    examples: [
      {
        input: 'group_names([{"category": "A", "name": "x"}, {"category": "A", "name": "y"}])',
        output: '{"A": ["x", "y"]}',
      },
    ],
  },
...
- pipeline(numbers) — apply only_positive then square_all, return list`,
    ...
    starter: `def only_positive(numbers):
    # Write your code here
    pass
...
def pipeline(numbers):
    ...
    pass
`,
    solution: `def only_positive(numbers):
...
Use re.sub to replace tags with empty strings. Assume well-formed tags, no nesting of same tag.`,
    ...
    hints: [String.raw`re.sub(r"</?\w+>", "", html)`],
    ...
    tests: [
      {
        ...
        call: 'strip_tags("<b>Hi</b> <i>there</i>")',
        expected: '"Hi there"',
      },
